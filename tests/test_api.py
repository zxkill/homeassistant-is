...
_load_module("custom_components.intersvyaz.const", "const.py")
...
async def api_server(aiohttp_server):
    ...
    app.router.add_post("/auth/phone", handle_phone)
...
async def test_full_authorization_flow(api_server) -> None:
    ...
    async with ClientSession() as session:
        ...
        token_info = await client.async_confirm_code("+70000000000", "1234")
